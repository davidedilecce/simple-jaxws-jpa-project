 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://applica/", wsdlLocation = "http://localhost:8080/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://applica/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://applica/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://applica/", "HelloWorldPort"), HelloWorld.class, features);
    }
